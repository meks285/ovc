...
<html lang="en">
<head>
  	<title>Household List | OVC</title>
    <meta charset="utf-8">
...
<!-- Inhouse JS -->
<script src="./js/householdlist.js"></script>
<script>
...
<body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li class="active">
	            <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle"><span style="font-weight: 600;">HouseHold</span></a>
	            <ul class="list-unstyled" id="homeSubmenu">
					<li class="active">
						<a href="#"><span style="font-weight: 600;">HouseHold List</span></a>
					</li>
					<li>
