...
$data = array();
   foreach($patientRecords as $row){
    ...
    $hh_unique_num = $row['hh_unique_num'];
         $data[] = array(
           "hh_unique_num"=>"<a style='font-weight: 500' href='./edit-vl-reception-form.php?data_id=".$data_id."'>".$hh_unique_num."</a>",
           "state"=>$row['state'],
            "lga"=>$row['lga'],
            "ward"=>$row['ward'],
            ...
            <div class='dropdown-menu'>
              <a class='dropdown-item' href='./edit-notifications-recipient.php?data_id=".$data_id."'>Open/View</a>
