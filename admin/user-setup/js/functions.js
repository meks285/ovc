...
function submitForm(ev){
    ...
    rpt_password = document.getElementById("rpt_password").value;
        ...
        if(cbo_code=="" || cbo_code=="Select CBO"){document.getElementById("cbo_code_label").innerHTML="Field is required";cbo_code_chk=0;}else{cbo_code_chk=1;document.getElementById("cbo_code_label").innerHTML="";}
        ...
        if(role=="" || role=="Select"){document.getElementById("role_label").innerHTML="Field is required";role_chk=0;}else{role_chk=1;document.getElementById("role_label").innerHTML="";}
        ...
        if(privilege==""){document.getElementById("privilege_label").innerHTML="Field is required";privilege_chk=0;}else{privilege_chk=1;document.getElementById("privilege_label").innerHTML="";}
   
   
   
//Confirm validation and set validation status
        if(state_chk == 0 ||lga_chk == 0 ||cbo_code_chk == 0 ||username_chk == 0 ||firstname_chk == 0 ||lastname_chk == 0 ||phonenumber_chk == 0  ||role_chk == 0  ||email_chk == 0  ||password_chk == 0  ||privilege_chk == 0  ){
...
function createUserRecord(){
    ...
    $.ajax({
        ...
        type: 'post',
        data: "cbo_code="+cbo_code+"&username="+username+"&state="+state+"&lga="+lga+"&firstname="+firstname+"&lastname="+lastname+"&phonenumber="+phonenumber+"&role="+role+"&email="+email+"&password="+password+"&privilege="+privilege,  
        dataType: 'json',
        success: function(response){ 
          if(response.status=="success"){
            Toastify({
                ...
                document.getElementById("lga").selectedIndex=-1;
                ...
                document.getElementById("privilege").selectedIndex=-1;                
